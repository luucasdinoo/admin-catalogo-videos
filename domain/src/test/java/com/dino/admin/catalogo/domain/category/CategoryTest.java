...
public class CategoryTest {
    ...
    public void givenAInvalidNameLengthMoreThan255_whenCallNewCategoryAndValidate_thenShouldReceiveError() {
        final String expectedName = """
                Gostaria de enfatizar que o desenvolvimento contínuo de distintas formas de atuação talvez venha a 
                ressaltar a relatividade das posturas dos órgãos dirigentes com relação às suas atribuições.
                Evidentemente, o entendimento das metas propostas aponta para a melhoria dos métodos utilizados na avaliação de resultados.
                """;
        final String expectedErrorMessage = "'name' must be between 3 and 255 characters";
        final var expectedErrorCount = 1;
        final var expectedDescription = "A categoria mais assistida";
    ...
    @Test
    public void givenAValidActivateCategory_whenCallDeactivate_thenReturnCategoryInactivate() {
        final String expectedName = "Filmes";
        final var expectedDescription = "A categoria mais assistida";
        final var expectedIsActive = false;
