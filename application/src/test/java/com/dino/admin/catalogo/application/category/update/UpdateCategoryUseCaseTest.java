...
public class UpdateCategoryUseCaseTest extends UseCaseTest {
    ...
    public void givenAValidCommand_whenCallsUpdateCategory_shouldReturnCategoryId() {
        ...
        final var aRequest = UpdateCategoryRequest.with(
                expectedId.getValue(),
                expectedName,
                expectedDescription,
                expectedIsActive
        ...
        final var actualOutput = useCase.execute(aRequest).get();
    ...
    public void givenAInvalidName_whenCallsUpdateCategory_thenShouldReturnDomainException(){
        ...
        final var aRequest = UpdateCategoryRequest.with(expectedId.getValue(), expectedName, expectedDescription, expectedIsActive);

        when(categoryGateway.findById(eq(expectedId)))
                .thenReturn(Optional.of(aCategory.clone()));

        final var notification = useCase.execute(aRequest).getLeft();
